...
nnp_convolution_transform_strategy nnp_kts(
  ...
  enum nnp_convolution_transform_strategy  kernel_transform_strategy =
...
void caffe_nnp_convolution_forward(
  ...
  if (batch_size == 1) {
    ...
    const enum nnp_status status = nnp_convolution_inference(
        algorithm,
        kernel_transform_strategy,
        input_channels,
        output_channels,
    ...
    const enum nnp_status status = nnp_convolution_output(
        algorithm,
        batch_size,
        input_channels,
        output_channels,
