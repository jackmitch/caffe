...
snapshot_dir = data_root_dir + "models/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = data_root_dir + "jobs/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = data_root_dir + "results/{}/Main".format(job_name)
