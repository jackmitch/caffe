...
net = caffe.Net('/host-ssd1TB/ssd_vggm/models/vgg_m_faces_deploy.prototxt', '/host-ssd1TB/ssd_vggm/models/vgg_m_faces.caffemodel', caffe.TEST)
...
net_full_conv = caffe.Net('/host-ssd1TB/ssd_vggm/models/vgg_m_faces_conv_deploy.prototxt', '/host-ssd1TB/ssd_vggm/models/vgg_m_faces.caffemodel', caffe.TEST)
...
conv_params['fc6-conv'][0][...] = fc_params['fc6'][0].reshape(4096, 512, 6, 6)[::4, :, ::2, ::2]
...
net_full_conv.save('/host-ssd1TB/ssd_vggm/models/vgg_m_faces_conv.caffemodel')
