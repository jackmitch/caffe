...
class Layer {
 public:
   ...
   */
  virtual void ToProto(LayerParameter* param, bool write_diff = false, bool write_data = true);
...
template <typename Dtype>
void Layer<Dtype>::ToProto(LayerParameter* param, bool write_diff, bool write_data) {
  param->Clear();
